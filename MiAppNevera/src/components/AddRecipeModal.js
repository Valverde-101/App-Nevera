  ...
  const resizeImage = pct => {
    if (isWeb) {
      ...
      richText.current?.commandDOM?.(`(function(){
        ...
        else if(range.startContainer.previousSibling && range.startContainer.previousSibling.tagName==='IMG') img=range.startContainer.previousSibling;
        ...
        >
          ...
          {isWeb ? (
            ...
            <>
              ...
              <RichToolbar
                editor={richText}
                actions={[actions.setBold, actions.insertBulletsList, actions.insertOrderedList, actions.insertImage, 'resize50', 'resize25']}
